...
/*
    ...
    @access : PRIVATE
 */
router.put("/experience", authenticate, async (request, response) => {
  try {
...
/*
    @usage : Get all Profiles except user with feature to follow and unfollow
    @url : /api/profiles/all/me
    @fields : no-fields
    @method : GET
    @access : PRIVATE
 */
router.get("/all/me", authenticate, async (request, response) => {
  try {
